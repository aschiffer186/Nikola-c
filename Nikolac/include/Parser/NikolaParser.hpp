...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    VEC_STAR_ASSIGN = 42,          // "*<="
    VEC_SLASH_ASSIGN = 43,         // "/<="
    VEC_DOUBLE_SLASH_ASSIGN = 44,  // "//<="
    VEC_CARET_ASSIGN = 45,         // "^<="
    VEC_PERCENT_ASSIGN = 46,       // "%<="
    DOUBLE_AMP = 47,               // "&&"
    DOUBLE_PIPE = 48,              // "||"
    BANG = 49,                     // "!"
    LESS = 50,                     // "<"
    ...
    AMP_ASSIGN = 63,               // "&="
    PIPE_ASSIGN = 64,              // "|="
    DOUBLE_CARET_ASSIGN = 65,      // "^^="
    TILDE_ASSIGN = 66,             // "~="
    LEFT_SHIFT_ASSIGN = 67,        // "<<="
    RIGHT_SHIFT_ASSIGN = 68,       // ">>="
    VEC_AMP = 69,                  // "&<"
    VEC_PIPE = 70,                 // "|<"
    VEC_DOUBLE_CARET = 71,         // "^^<"
    VEC_TILDE = 72,                // "~<"
    ...
    VEC_AMP_ASSIGN = 75,           // "&<="
    VEC_PIPE_ASSIGN = 76,          // "|<="
    VEC_DOUBLE_CARET_ASSIGN = 77,  // "^^<="
    VEC_TILDE_ASSIGN = 78,         // "~<="
    VEC_LEFT_SHIFT_ASSIGN = 79,    // "<<<="
    VEC_RIGHT_SHIFT_ASSIGN = 80,   // ">><="
    ASSIGN = 81,                   // "="
    LEFT_ARROW = 82,               // "<-"
    PLUS_PLUS = 83,                // "++"
    MINUS_MINUS = 84,              // "--"
    ...
    INT64_T = 92,                  // "int64_t"
    INT = 93,                      // "int"
    REAL32_T = 94,                 // "real32_t"
    REAL64_T = 95,                 // "real64_t"
    REAL = 96,                     // "real"
    BOOL = 97,                     // "bool"
    CHAR = 98,                     // "char"
    MOD = 99,                      // "mod"
    ...
    CLASS = 117,                   // "class"
    PUBLIC = 118,                  // "public"
    PROTECTED = 119,               // "protected"
    PRIVATE = 120,                 // "private"
    ENUM = 121,                    // "enum"
    CONSTRUCTOR = 122,             // "constructor"
    DESTRUCTOR = 123,              // "destructor"
    DEFAULT = 124,                 // "default"
    DEFINE = 125,                  // "define"
    IF = 126,                      // "if"
    ELSE = 127,                    // "else"
    ...
    BREAK = 135,                   // "break"
    RETURN = 136,                  // "return"
    CONTINUE = 137,                // "continue"
    MATCH = 138,                   // "match"
    WHEN = 139,                    // "when"
    TYPESET = 140,                 // "typeset"
    TEMPLATE = 141,                // "template"
    WHERE = 142,                   // "where"
    TYPE = 143,                    // "type"
    MODULE = 144,                  // "module"
    NAMESPACE = 145,               // "namespace"
    IMPORT = 146,                  // "import"
    FROM = 147,                    // "from"
    AS = 148,                      // "as"
    WITH = 149,                    // "with"
    ...
    SIZEOF = 151,                  // "sizeof"
    TYPEOF = 152,                  // "typeof"
    STATIC_ASSERT = 153,           // "static_assert"
    ASSERT = 154,                  // "assert"
    NEW = 155,                     // "new"
    DYNAMIC = 156                  // "dynamic"
      };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_VEC_STAR = 35,                         // "*<"
        S_VEC_SLASH = 36,                        // "/<"
        S_VEC_DOUBLE_SLASH = 37,                 // "//<"
        S_VEC_CARET = 38,                        // "^<"
        S_VEC_PERCENT = 39,                      // "%<"
        S_VEC_PLUS_ASSIGN = 40,                  // "+<="
        S_VEC_MINUS_ASSIGN = 41,                 // "-<="
        S_VEC_STAR_ASSIGN = 42,                  // "*<="
        S_VEC_SLASH_ASSIGN = 43,                 // "/<="
        S_VEC_DOUBLE_SLASH_ASSIGN = 44,          // "//<="
        S_VEC_CARET_ASSIGN = 45,                 // "^<="
        S_VEC_PERCENT_ASSIGN = 46,               // "%<="
        S_DOUBLE_AMP = 47,                       // "&&"
        S_DOUBLE_PIPE = 48,                      // "||"
        S_BANG = 49,                             // "!"
        S_LESS = 50,                             // "<"
        ...
        S_AMP_ASSIGN = 63,                       // "&="
        S_PIPE_ASSIGN = 64,                      // "|="
        S_DOUBLE_CARET_ASSIGN = 65,              // "^^="
        S_TILDE_ASSIGN = 66,                     // "~="
        S_LEFT_SHIFT_ASSIGN = 67,                // "<<="
        S_RIGHT_SHIFT_ASSIGN = 68,               // ">>="
        S_VEC_AMP = 69,                          // "&<"
        S_VEC_PIPE = 70,                         // "|<"
        S_VEC_DOUBLE_CARET = 71,                 // "^^<"
        S_VEC_TILDE = 72,                        // "~<"
        S_VEC_LEFT_SHIFT = 73,                   // "<<<"
        S_VEC_RIGHT_SHIFT = 74,                  // ">><"
        S_VEC_AMP_ASSIGN = 75,                   // "&<="
        S_VEC_PIPE_ASSIGN = 76,                  // "|<="
        S_VEC_DOUBLE_CARET_ASSIGN = 77,          // "^^<="
        S_VEC_TILDE_ASSIGN = 78,                 // "~<="
        S_VEC_LEFT_SHIFT_ASSIGN = 79,            // "<<<="
        S_VEC_RIGHT_SHIFT_ASSIGN = 80,           // ">><="
        S_ASSIGN = 81,                           // "="
        S_LEFT_ARROW = 82,                       // "<-"
        S_PLUS_PLUS = 83,                        // "++"
        S_MINUS_MINUS = 84,                      // "--"
        ...
        S_QUESTION = 88,                         // "?"
        S_INT8_T = 89,                           // "int8_t"
        S_INT16_T = 90,                          // "int16_t"
        S_INT32_T = 91,                          // "int32_t"
        S_INT64_T = 92,                          // "int64_t"
        S_INT = 93,                              // "int"
        S_REAL32_T = 94,                         // "real32_t"
        S_REAL64_T = 95,                         // "real64_t"
        S_REAL = 96,                             // "real"
        S_BOOL = 97,                             // "bool"
        S_CHAR = 98,                             // "char"
        S_MOD = 99,                              // "mod"
        ...
        S_LET = 105,                             // "let"
        S_CONST = 106,                           // "const"
        S_COMPEVAL = 107,                        // "compeval"
        S_PURE = 108,                            // "pure"
        S_STATIC = 109,                          // "static"
        S_NOTHROW = 110,                         // "nothrow"
        S_IN = 111,                              // "in"
        S_INOUT = 112,                           // "inout"
        S_OUT = 113,                             // "out"
        S_MOVE = 114,                            // "move"
        S_OPERATOR = 115,                        // "operator"
        S_DELETE = 116,                          // "delete"
        S_CLASS = 117,                           // "class"
        S_PUBLIC = 118,                          // "public"
        S_PROTECTED = 119,                       // "protected"
        S_PRIVATE = 120,                         // "private"
        S_ENUM = 121,                            // "enum"
        S_CONSTRUCTOR = 122,                     // "constructor"
        S_DESTRUCTOR = 123,                      // "destructor"
        S_DEFAULT = 124,                         // "default"
        S_DEFINE = 125,                          // "define"
        S_IF = 126,                              // "if"
        S_ELSE = 127,                            // "else"
        S_ELSE_IF = 128,                         // "else if"
        S_FOR = 129,                             // "for"
        S_DO = 130,                              // "do"
        S_WHILE = 131,                           // "while"
        S_TRY = 132,                             // "try"
        ...
        S_BREAK = 135,                           // "break"
        S_RETURN = 136,                          // "return"
        S_CONTINUE = 137,                        // "continue"
        S_MATCH = 138,                           // "match"
        S_WHEN = 139,                            // "when"
        S_TYPESET = 140,                         // "typeset"
        S_TEMPLATE = 141,                        // "template"
        S_WHERE = 142,                           // "where"
        S_TYPE = 143,                            // "type"
        S_MODULE = 144,                          // "module"
        S_NAMESPACE = 145,                       // "namespace"
        S_IMPORT = 146,                          // "import"
        S_FROM = 147,                            // "from"
        S_AS = 148,                              // "as"
        S_WITH = 149,                            // "with"
        ...
        S_SIZEOF = 151,                          // "sizeof"
        S_TYPEOF = 152,                          // "typeof"
        S_STATIC_ASSERT = 153,                   // "static_assert"
        S_ASSERT = 154,                          // "assert"
        S_NEW = 155,                             // "new"
        S_DYNAMIC = 156,                         // "dynamic"
